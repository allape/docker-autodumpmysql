...
### Credits
### https://github.com/docker-library/mysql/blob/f59266f3ec6f1ddfc66d1db613430d9dcc52419b/8.4/docker-entrypoint.sh
...
### region mark change part
    # start auto dump, log will be written into current io
    nohup /usr/local/bin/autodump &
### endregion
